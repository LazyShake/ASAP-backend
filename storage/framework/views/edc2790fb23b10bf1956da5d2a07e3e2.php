...
} elseif ($_instance->childHasBeenRendered('s9YqCUU')) {
    $componentId = $_instance->getRenderedChildComponentId('s9YqCUU');
    $componentTag = $_instance->getRenderedChildComponentTagName('s9YqCUU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('s9YqCUU');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('s9YqCUU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH D:\OSPanel\domains\asap-new-site-dev\back\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>