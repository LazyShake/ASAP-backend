...
} elseif ($_instance->childHasBeenRendered('EKEf0ES')) {
    $componentId = $_instance->getRenderedChildComponentId('EKEf0ES');
    $componentTag = $_instance->getRenderedChildComponentTagName('EKEf0ES');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EKEf0ES');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('EKEf0ES', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH D:\OSPanel\domains\asap-new-site-dev-main\back\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>