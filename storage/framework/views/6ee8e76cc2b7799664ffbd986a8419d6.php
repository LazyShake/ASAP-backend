...
} elseif ($_instance->childHasBeenRendered('JDAvs1y')) {
    $componentId = $_instance->getRenderedChildComponentId('JDAvs1y');
    $componentTag = $_instance->getRenderedChildComponentTagName('JDAvs1y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JDAvs1y');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('JDAvs1y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('e4RvBzE')) {
    $componentId = $_instance->getRenderedChildComponentId('e4RvBzE');
    $componentTag = $_instance->getRenderedChildComponentTagName('e4RvBzE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('e4RvBzE');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('e4RvBzE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\OSPanel\domains\asap-new-site-dev-main\back\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>