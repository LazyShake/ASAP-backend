...
} elseif ($_instance->childHasBeenRendered('RUnZsYO')) {
    $componentId = $_instance->getRenderedChildComponentId('RUnZsYO');
    $componentTag = $_instance->getRenderedChildComponentTagName('RUnZsYO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RUnZsYO');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('RUnZsYO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Q5mwSzO')) {
    $componentId = $_instance->getRenderedChildComponentId('Q5mwSzO');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q5mwSzO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q5mwSzO');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('Q5mwSzO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\OSPanel\domains\asap-new-site-dev\back\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>